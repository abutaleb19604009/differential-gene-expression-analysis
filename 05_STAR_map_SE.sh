...
do
	...
	STAR --readFilesCommand gunzip -c --outSAMunmapped Within --outMultimapperOrder Random --outSAMmultNmax 1 --runThreadN 4 --runMode alignReads --quantMode GeneCounts --outSAMtype BAM SortedByCoordinate --outFileNamePrefix ${myDir}/../output/${sampleID}/star/${sampleID}.onemap. --genomeDir ${myDir}/../resources/ --readFilesIn ${myDir}/../output/${sampleID}/trimmomatic/${sampleID}.trim.fq.gz
